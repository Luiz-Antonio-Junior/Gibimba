            ...
            <div class="w-full md:w-1/2 flex flex-col items-center h-64">
                <div class="w-full px-4">
                    <div class="flex flex-col items-center relative">
                        <div class="w-full">
                            <h1 class="w-full text-5xl text-gray-100 font-bold mb-5">Pesquisar Convidado</h1>
                            <div>
                                <form class="my-2 p-1 bg-gray-900 flex border border-gray-900 rounded" method="get" action="{{route('guests.search')}}">
                                    <input name="search" placeholder="Pesquisar Convidado"
                                            ...
                                            <div class="w-6 flex flex-col items-center">
                                                <div
                                                    ...
                                                    <img class="rounded-full" alt="A"
                                                         src="https://randomuser.me/api/portraits/men/{{$guest->id}}.jpg"></div>
                                            </div>
                                            <div class="w-full items-center flex">
                                                <div class="mx-2 -mt-1 text-gray-300 ">{{$guest->name}} {{$guest->last_name}}</div>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
