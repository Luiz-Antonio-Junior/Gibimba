            ...
            <div class="w-full md:w-1/2 flex flex-col items-center h-64">
                <div class="w-full px-4">
                    <div class="flex flex-col items-center relative">
                        <div class="w-full">
                            <h1 class="w-full text-5xl text-gray-100 font-bold mb-5">Pesquisar Sala de Evento</h1>
                            <div>
                                <form class="my-2 p-1 bg-gray-900 flex border border-gray-900 rounded" method="get" action="{{route('event.search')}}">
                                    <input name="search" placeholder="Pesquisar Sala de Evento"
                        ...
                        <div
                            ...
                            <div class="flex flex-col w-full">
                                @foreach($eventRooms as $eventRoom)
                                    <a href="{{route('event.show', $eventRoom->id)}}"
                                        ...
                                        <div
                                            ...
                                            <div class="w-full items-center flex">
                                                <div class="mx-2 -mt-1 text-gray-300 ">{{$eventRoom->name}} ___ {{$eventRoom->capacity}}</div>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
